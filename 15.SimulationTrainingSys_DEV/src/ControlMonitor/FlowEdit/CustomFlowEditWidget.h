...
namespace CUSTOM_FLOW_EDIT_WIDGET {
	...
	public:
		static CustomFlowEditWidget* instance;
		static CustomFlowEditWidget* getInstance() {
			if (instance == nullptr)
			{
				instance = new CustomFlowEditWidget;
			}

			return instance;
		}

		static void closeFlowEdit() {
			instance->~CustomFlowEditWidget();
		}
