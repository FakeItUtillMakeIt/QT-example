#include "ReceiveCMDDataF.h"
#include <QDateTime>
#include "../../Public/CRC.h"


#define FRAMELENGTH 10
ReceiveCMDDataF::ReceiveCMDDataF(string IP, unsigned int Port,QObject* parent)
	: QObject(parent),
...
ReceiveCMDDataF::~ReceiveCMDDataF()
{ 
}

void ReceiveCMDDataF::init(string strIP, unsigned int iPort)
{
    ...
    connect(m_pCMDSocket, &QUdpSocket::readyRead, this, &ReceiveCMDDataF::receiveData); 
}


void ReceiveCMDDataF::receiveData()
{
