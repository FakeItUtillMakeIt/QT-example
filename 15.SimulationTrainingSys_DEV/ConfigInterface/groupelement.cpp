...
{
    {
          ...
          m_valueSet.valuelist[GroupElement::eStyleInfo] = new ConfigValue(new char[MaximumPathLength],eConfigStyleInfo,"样式选择");
          m_valueSet.valuelist[GroupElement::eTitleInfo] = new ConfigValue(new char[MaximumPathLength],eConfigString,"标题设置");
    ...
    }
    {
          ...
          m_valueSet.valuelist[GroupElement::eXPos] = new ConfigValue(new int(5),eConfigInt,"X坐标");
          m_valueSet.valuelist[GroupElement::eYPos] = new ConfigValue(new int(2),eConfigInt,"Y坐标");
          m_valueSet.valuelist[GroupElement::eWidth] = new ConfigValue(new int(5),eConfigInt,"宽度");
          m_valueSet.valuelist[GroupElement::eHeight] = new ConfigValue(new int(5),eConfigInt,"高度");
...
void GroupElement::updateGeometryData()
{
    ...
    *(int*)m_valueSetMap["位置属性"].valuelist[GroupElement::eXPos]->value  = m_xPos;
    *(int*)m_valueSetMap["位置属性"].valuelist[GroupElement::eYPos]->value  = m_yPos;
    *(int*)m_valueSetMap["位置属性"].valuelist[GroupElement::eWidth]->value  = m_width;
    *(int*)m_valueSetMap["位置属性"].valuelist[GroupElement::eHeight]->value  = m_height;
}
...
{
    qDebug() <<"GroupElement::updataDataFromTool 1";

    m_xPos   = *(int*)m_valueSetMap["位置属性"].valuelist[GroupElement::eXPos]->value;
    qDebug() <<"GroupElement::updataDataFromTool 2:" <<m_xPos;

    qDebug() << "updataDataFromTool:"<<m_xPos;
    m_yPos   = *(int*)m_valueSetMap["位置属性"].valuelist[GroupElement::eYPos]->value;
    m_width  = *(int*)m_valueSetMap["位置属性"].valuelist[GroupElement::eWidth]->value;
    m_height = *(int*)m_valueSetMap["位置属性"].valuelist[GroupElement::eHeight]->value;
    titletext = m_valueSetMap["样式配置"].valuelist[GroupElement::eTitleInfo]->getStrValue();
    qDebug() <<"GroupElement::updataDataFromTool 3:" <<m_yPos;

   updataGeometryFromData();
   qDebug() <<"GroupElement::updataDataFromTool 4:" <<m_width;

   qDebug() <<"GroupElement::updataDataFromTool 5:" <<m_height;
    UpdatePropertyByStyle();
   resetLaoutFromData();
   qDebug() <<"GroupElement::updataDataFromTool 6";
