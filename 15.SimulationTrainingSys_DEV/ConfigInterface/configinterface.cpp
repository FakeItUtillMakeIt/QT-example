...
void  ConfigInterface::firstinitFromOut(QList<QPushButton*> btnlist)
{
      ...
      //  OpenStyleManager->setFixedSize(30,30);
        ...
        int colcount = 3;
        //    gridlayout->addWidget(groupselector,0,colcount++,1,1);
        //    gridlayout->addWidget(btnselector,0,colcount++,1,1);
        //    gridlayout->addWidget(pairlabelselector,0,colcount++,1,1);
        //    gridlayout->addWidget(curveselector,0,colcount++,1,1);
        //    gridlayout->addWidget(savescene,0,colcount++,1,1);
        //    gridlayout->addWidget(OpenStyleManager,0,colcount++,1,1);
        //    gridlayout->addWidget(btn,0,colcount++,1,1);
...
void ConfigInterface::DeleteSceneByBtnFromOut(QPushButton* delBtn)
{
    configplatform->DeleteSceneByBtnFromOut(delBtn);
