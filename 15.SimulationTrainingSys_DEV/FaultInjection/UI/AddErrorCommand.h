...
private:
	...
	void onCommandNameChanged(QString tempName); 
	void InitTable();
	...
	void ShowAllParamTable(int index);
...
private:
	...
	vector<ItemStruct> m_faultItems;
	map<int, int> m_indexCommand;//索引和故障指令id,在界面上cb_commandName根据指定项选择
	...
	//vector<int> m_paramCommandId;//记录当前故障关联的参数
